...
urlpatterns = [
    ...
    url(r'^user/', include([
        ...
        url(r'^(?P<u_id>\d+)/reset-password$', reset_password),
        url(r'^(?P<u_id>\d+)$', user_profile),
        url(r'^(?P<u_id>\d+)/photo$', user_profile_photo),
        url(r'^(?P<u_id>\d+)/logout$', logout),
    ])),
    ...
    url(r'^course/', include([
        ...
        url(r'^(?P<c_id>\d+)/remove$', remove_course),
        url(r'^(?P<c_id>\d+)/student$', course_students_list),
    ])),
    ...
    url(r'^course/(?P<c_id>\d+)/exam/$', include([
        url(r'^$', exams_list),
        url(r'^add$', create_exam),
        url(r'^(?P<e_id>\d+)/remove$', remove_exam),
        url(r'^(?P<e_id>\d+)/student/(?P<s_id>\w+)/score-and-comment$', exam_scoring_and_comment),
        url(r'^(?P<e_id>\d+)/finish-scoring$', finish_scoring),
        url(r'^(?P<e_id>\d+)/result$', exam_result),
        url(r'^(?P<e_id>\d+)/pause$', pause_exam),
        url(r'^(?P<e_id>\d+)/resume$', resume_exam),
        url(r'^(?P<e_id>\d+)/halt$', halt_exam),
        url(r'^(?P<e_id>\d+)/extend$', extend_exam),
        url(r'^(?P<e_id>\d+)/chat/send-message$', send_message),
        url(r'^(?P<e_id>\d+)/chat/history$', chat_history),
    ])),

    # url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem$', problems_list),
    # url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/add$', create_problem),
    # url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/student/(?P<s_id>\w+)/source-code$',
    #     source_code_and_result),
    # url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/student/(?P<s_id>\w+)/score-and-comment$',
    #     problem_scoring_and_comment),
    ...
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/', include([
        url(r'^problem$', problems_list),
        url(r'^problem/add$', create_problem),
        url(r'^problem/(?P<p_id>\d+)/student/(?P<s_id>\w+)/source-code$',
            source_code_and_result),
        url(r'^problem/(?P<p_id>\d+)/student/(?P<s_id>\w+)/score-and-comment$',
            problem_scoring_and_comment),
        url(r'^problem/(?P<p_id>\d+)/testdata$', get_test_data),
        url(r'^student/(?P<s_id>\w+)/attend$', attend_exam),
        url(r'^student/(?P<s_id>\w+)/snapshot$', snapshot),
        url(r'^student/(?P<s_id>\w+)/request-current-snapshot$',
            request_snapshot),
        url(r'^student/(?P<s_id>\w+)/monitor/start$', start_monitor),
        url(r'^student/(?P<s_id>\w+)/monitor/stop$', stop_monitor),
        url(r'^student/(?P<s_id>\w+)/monitor/send-key-event$', handle_key_event),
    ])),
]
