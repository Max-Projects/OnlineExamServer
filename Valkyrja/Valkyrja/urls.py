...
urlpatterns = [
    ...
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/student/(?P<s_id>\d+)/score-and-comment$', exam_scoring_and_comment),
    ...
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/student/(?P<s_id>\d+)/source-code$', source_code_and_result),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/student/(?P<s_id>\d+)/score-and-comment$', problem_scoring_and_comment),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/testdata$', get_test_data),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/attend$', attend_exam),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/snapshot$', snapshot),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/request-current-snapshot$', request_snapshot),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/monitor/start$', start_monitor),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/monitor/stop$', stop_monitor),
    url(r'^course/(?P<c_id>\d+)/exam/(?P<e_id>\d+)/problem/(?P<p_id>\d+)/monitor/send-key-event$', handle_key_event),
]
