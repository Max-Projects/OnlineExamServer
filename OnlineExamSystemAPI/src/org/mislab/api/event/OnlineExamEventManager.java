...
public class OnlineExamEventManager {
   ...
   class OnlineExamEventType {
    ...
    private OnlineExamEventManager() {
        ...
        listenerMgr.put( new OnlineExamEventType(EventType.User, EventAction.Login), 
                new ArrayList<>() );
        listenerMgr.put( new OnlineExamEventType(EventType.User, EventAction.Logout), 
                new ArrayList<>() );
        listenerMgr.put( new OnlineExamEventType(EventType.User, EventAction.Register), 
                new ArrayList<>() );
